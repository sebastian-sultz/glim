...
const Subscription=()=> {
  return (
    <div className='SubscriptionPage'>
        ...
        <div  ><h1>Subscription</h1></div>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde dolorem tempore perferendis delectus eligendi rerum quasi beatae facilis quidem, commodi iure, magnam impedit sit sint assumenda nulla aliquam reiciendis tenetur.
    ...
    Sit facere architecto explicabo. Hic quisquam veniam possimus officia in ipsa, ad, quidem repellendus natus quis blanditiis illo corrupti distinctio beatae? Consectetur veniam, ab tempore non modi facere illo earum.
    ...
    Perferendis incidunt id consectetur quasi, qui ex deleniti dicta, facere ipsa pariatur natus voluptatum? Eligendi autem amet minima aspernatur doloremque sapiente optio ratione veniam minus ullam. Error nihil vel fugiat?</div>
  )
}
